...
font_size['values'] = tuple(range(4,500))
font_size.current(4)
...
file.add_command(label='Save As', image=new_icon, compound=tk.LEFT, accelerator='Ctrl+Shift+S', command=save_as)
...
edit.add_command(label='Clear All', image=clear_all_icon, compound=tk.LEFT, accelerator='Ctrl+Shift+A', command= lambda:text_editor.delete(1.0, tk.END))
